...
open class TargetNodeCreator {
    ...
    /**
     ...
     - returns: target node
     */
    open static func create(_ degrees: CGFloat, rotation: CGFloat) -> TargetNode {
     ...
     */
    open static func create(_ pattern: TargetPattern) -> [TargetNode] {
     ...
     */
    open static func patternForStage(_ stage: Int) -> TargetPattern {
        // TODO: tweak values
