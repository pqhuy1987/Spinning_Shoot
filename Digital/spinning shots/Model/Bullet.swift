...
public struct Bullet: Entity {
    ...
    fileprivate(set) public var didHit = false      // indicating whether the bullet did hit a target when shot
    fileprivate(set) public var wasShot = false     // indicating whether the bullet was shot
